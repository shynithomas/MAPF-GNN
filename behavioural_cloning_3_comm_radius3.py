...
if __name__ == "__main__":
    ...
    EPOCHS_PER_TASK = 20
    env = RealTrafficEnvGeneral(body_len=1, comm_radius=3)
   ...
   #print(f"agent {agent.policy.parameters}")
    ...
    # Save trained model
    MODEL_SAVE_PATH="BC_config1_3CommRadius.pth"
    ...
    # Save the plot
    plt.savefig('LR_Config1_CommRadius3.png')
    ...
    plt.savefig('TL_Config1_CommRadius3.png')
    print("Loss plot saved as 'TL_Config1_CommRadius3.png'")
