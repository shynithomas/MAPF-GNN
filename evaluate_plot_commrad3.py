...
MAX_STEPS = 60  # Timeout threshold to prevent infinite loops For 16x16 =20, 32x32 =60
...
if __name__ == "__main__":
    ...
    MODEL_PATH = 'BC_config1_3CommRadius.pth'
    MAP_FILE = '../../maps/empty-32-32.map'
    SCEN_FILE = '../../scenarios/Testing/32-32/'
    NUM_AGENTS = 45
    ...
    for no_agents in range(5,100,5):
        ...
        for scenario_idx in range(1,50):
    ...
    with open("Result_3CommRadius.txt", "w") as file:
    ...
    plt.tight_layout()
    plt.savefig('evaluation_results_3CommRadius.png')
    print("\nEvaluation complete. Plots saved as 'evaluation_results.png'.")
    plt.show()    
